...
// Last updated: Q4 2025 (effective 10/01/2025 – 12/31/2025)
// Rates may change; always verify with your receipt.
    ...
    counties: [
      {
        ...
        countyTax: 9.75, // unincorporated areas (county-wide measures, no city additions)
        cities: [
          // ── 9.75% — county-wide measures, no city-specific additions ──
          { name: 'Agoura Hills',           totalTax: 9.75  },
          { name: 'Bell',                   totalTax: 9.75  },
          { name: 'Beverly Hills',          totalTax: 9.75  },
          { name: 'Bradbury',               totalTax: 9.75  },
          { name: 'Calabasas',              totalTax: 9.75  },
          { name: 'Cerritos',               totalTax: 9.75  },
          { name: 'Claremont',              totalTax: 9.75  },
          { name: 'Diamond Bar',            totalTax: 9.75  },
          { name: 'El Segundo',             totalTax: 9.75  },
          { name: 'Hermosa Beach',          totalTax: 9.75  },
          { name: 'Hidden Hills',           totalTax: 9.75  },
          { name: 'City of Industry',       totalTax: 9.75  },
          { name: 'La Habra Heights',       totalTax: 9.75  },
          { name: 'La Mirada',              totalTax: 9.75  },
          { name: 'Los Angeles',            totalTax: 9.75,  zipPrefix: ['900','901','902','903','904'] },
          { name: 'Maywood',                totalTax: 9.75  },
          { name: 'Palos Verdes Estates',   totalTax: 9.75  },
          { name: 'Rancho Palos Verdes',    totalTax: 9.75  },
          { name: 'Redondo Beach',          totalTax: 9.75  },
          { name: 'Rolling Hills',          totalTax: 9.75  },
          { name: 'Rolling Hills Estates',  totalTax: 9.75  },
          { name: 'Rosemead',               totalTax: 9.75  },
          { name: 'San Dimas',              totalTax: 9.75  },
          { name: 'San Marino',             totalTax: 9.75  },
          { name: 'Santa Clarita',          totalTax: 9.75  },
          { name: 'Temple City',            totalTax: 9.75  },
          { name: 'Walnut',                 totalTax: 9.75  },
          { name: 'West Covina',            totalTax: 9.75  },
          { name: 'Westlake Village',       totalTax: 9.75  },
          // ── 10.25% ──
          { name: 'Avalon',                 totalTax: 10.25 },
          { name: 'Inglewood',              totalTax: 10.25 },
          { name: 'La Puente',              totalTax: 10.25 },
          { name: 'Malibu',                 totalTax: 10.25 },
          { name: 'Manhattan Beach',        totalTax: 10.25 },
          { name: 'Torrance',               totalTax: 10.25 },
          // ── 10.5% — added local measures ──
          { name: 'Alhambra',               totalTax: 10.5  },
          { name: 'Arcadia',                totalTax: 10.5  },
          { name: 'Artesia',                totalTax: 10.5  },
          { name: 'Baldwin Park',           totalTax: 10.5  },
          { name: 'Bell Gardens',           totalTax: 10.5  },
          { name: 'Bellflower',             totalTax: 10.5  },
          { name: 'Burbank',                totalTax: 10.5  },
          { name: 'Carson',                 totalTax: 10.5  },
          { name: 'Commerce',               totalTax: 10.5,  },
          { name: 'Covina',                 totalTax: 10.5  },
          { name: 'Cudahy',                 totalTax: 10.5  },
          { name: 'Culver City',            totalTax: 10.5  },
          { name: 'Downey',                 totalTax: 10.5  },
          { name: 'Duarte',                 totalTax: 10.5  },
          { name: 'El Monte',               totalTax: 10.5  },
          { name: 'Gardena',                totalTax: 10.5  },
          { name: 'Glendale',               totalTax: 10.5  },
          { name: 'Hawaiian Gardens',       totalTax: 10.5  },
          { name: 'Hawthorne',              totalTax: 10.5  },
          { name: 'Huntington Park',        totalTax: 10.5  },
          { name: 'La Cañada Flintridge',   totalTax: 10.5  },
          { name: 'La Verne',               totalTax: 10.5  },
          { name: 'Lakewood',               totalTax: 10.5  },
          { name: 'Lawndale',               totalTax: 10.5  },
          { name: 'Lomita',                 totalTax: 10.5  },
          { name: 'Long Beach',             totalTax: 10.5,  zipPrefix: ['908'] },
          { name: 'Monrovia',               totalTax: 10.5  },
          { name: 'Montebello',             totalTax: 10.5  },
          { name: 'Monterey Park',          totalTax: 10.5  },
          { name: 'Norwalk',                totalTax: 10.5  },
          { name: 'Paramount',              totalTax: 10.5  },
          { name: 'Pasadena',               totalTax: 10.5  },
          { name: 'Pomona',                 totalTax: 10.5  },
          { name: 'San Fernando',           totalTax: 10.5  },
          { name: 'San Gabriel',            totalTax: 10.5  },
          { name: 'Sierra Madre',           totalTax: 10.5  },
          { name: 'Signal Hill',            totalTax: 10.5  },
          { name: 'South Pasadena',         totalTax: 10.5  },
          { name: 'Vernon',                 totalTax: 10.5  },
          { name: 'West Hollywood',         totalTax: 10.5  },
          { name: 'Whittier',               totalTax: 10.5  },
          // ── 10.75% — additional local measures ──
          { name: 'Azusa',                  totalTax: 10.75 },
          { name: 'Compton',                totalTax: 10.75 },
          { name: 'Glendora',               totalTax: 10.75 },
          { name: 'Irwindale',              totalTax: 10.75 },
          { name: 'Lynwood',                totalTax: 10.75 },
          { name: 'Pico Rivera',            totalTax: 10.75 },
          { name: 'Santa Fe Springs',       totalTax: 10.75 },
          { name: 'Santa Monica',           totalTax: 10.75 },
          { name: 'South El Monte',         totalTax: 10.75 },
          { name: 'South Gate',             totalTax: 10.75 },
          // ── 11.25% — Lancaster & Palmdale special ──
          { name: 'Lancaster',              totalTax: 11.25 },
          { name: 'Palmdale',               totalTax: 11.25 },
        ],
      },
      {
        name: 'Orange County',
        countyTax: 7.75,
        cities: [
          // ── 7.75% — county base, no city additions ──
          ...
          // ── 8.75% — added local measures ──
          { name: 'Buena Park',             totalTax: 8.75 },
          { name: 'Fountain Valley',        totalTax: 8.75 },
          { name: 'Garden Grove',           totalTax: 8.75 },
          { name: 'La Habra',               totalTax: 8.75 },
          { name: 'La Palma',               totalTax: 8.75 },
          { name: 'Placentia',              totalTax: 8.75 },
          { name: 'Stanton',                totalTax: 8.75 },
          // ── 9.25% — higher local additions ──
          { name: 'Los Alamitos',           totalTax: 9.25 },
          { name: 'Santa Ana',              totalTax: 9.25 },
          { name: 'Seal Beach',             totalTax: 9.25 },
          { name: 'Westminster',            totalTax: 9.25 },
        ],
      },
      {
      ...
      },
      {
        ...
        cities: [
          ...
          { name: 'Santa Clara',  totalTax: 9.125, zipPrefix: ['950'] },
          { name: 'Saratoga',     totalTax: 9.125 },
          { name: 'Sunnyvale',    totalTax: 9.125, zipPrefix: ['940'] },
          { name: 'Campbell',     totalTax: 9.875 },
        ],
      },
      {
        name: 'Alameda County',
        ...
        cities: [
          ...
          { name: 'Berkeley',    totalTax: 10.25, zipPrefix: ['947'] },
          { name: 'Hayward',     totalTax: 10.75 },
          { name: 'Newark',      totalTax: 10.75 },
          { name: 'Oakland',     totalTax: 10.75, zipPrefix: ['946'] },
          { name: 'San Leandro', totalTax: 10.75 },
          { name: 'Union City',  totalTax: 10.75 },
        ],
      },
      {
        ...
        cities: [
          ...
          // ── 8.25% ──
          { name: 'El Cajon',      totalTax: 8.25  },
          { name: 'Oceanside',     totalTax: 8.25  },
          { name: 'Vista',         totalTax: 8.25  },
          // ── 8.5% ──
          { name: 'La Mesa',       totalTax: 8.5   },
          // ── 8.75% ──
          { name: 'Chula Vista',   totalTax: 8.75  },
          { name: 'Del Mar',       totalTax: 8.75  },
          { name: 'Escondido',     totalTax: 8.75  },
          { name: 'Imperial Beach',totalTax: 8.75  },
          { name: 'Lemon Grove',   totalTax: 8.75  },
          { name: 'National City', totalTax: 8.75  },
          { name: 'San Marcos',    totalTax: 8.75  },
          { name: 'Solana Beach',  totalTax: 8.75  },
        ],
      },
      {
        ...
        countyTax: 8.75,
        cities: [
          { name: 'Citrus Heights',  totalTax: 7.75  },
          { name: 'Elk Grove',       totalTax: 8.75  },
          { name: 'Folsom',          totalTax: 7.75  },
          { name: 'Galt',            totalTax: 9.25  },
      ...
      },
      {
        ...
        countyTax: 7.75,
        cities: [
          { name: 'Adelanto',          totalTax: 7.75  },
          { name: 'Apple Valley',      totalTax: 8.75  },
          { name: 'Barstow',           totalTax: 8.75  },
          { name: 'Big Bear Lake',     totalTax: 7.75  },
          { name: 'Chino',             totalTax: 8.75  },
          { name: 'Chino Hills',       totalTax: 7.75  },
          { name: 'Colton',            totalTax: 8.75  },
          { name: 'Fontana',           totalTax: 8.75  },
          { name: 'Grand Terrace',     totalTax: 7.75  },
          { name: 'Hesperia',          totalTax: 7.75  },
          { name: 'Highland',          totalTax: 7.75  },
          { name: 'Loma Linda',        totalTax: 7.75  },
          { name: 'Montclair',         totalTax: 9.0   },
          { name: 'Needles',           totalTax: 7.75  },
          { name: 'Ontario',           totalTax: 8.75  },
          { name: 'Rancho Cucamonga',  totalTax: 7.75  },
          { name: 'Redlands',          totalTax: 8.75  },
          { name: 'Rialto',            totalTax: 7.75  },
          { name: 'San Bernardino',    totalTax: 8.75  },
          { name: 'Twentynine Palms',  totalTax: 7.75  },
          { name: 'Upland',            totalTax: 7.75  },
          { name: 'Victorville',       totalTax: 8.75  },
          { name: 'Yucaipa',           totalTax: 8.75  },
          { name: 'Yucca Valley',      totalTax: 8.75  },
        ],
      },
      {
        ...
        countyTax: 7.75,
        cities: [
          { name: 'Banning',          totalTax: 7.75  },
          { name: 'Beaumont',         totalTax: 7.75  },
          { name: 'Blythe',           totalTax: 8.75  },
          { name: 'Calimesa',         totalTax: 7.75  },
          { name: 'Canyon Lake',      totalTax: 7.75  },
          { name: 'Cathedral City',   totalTax: 9.25  },
          { name: 'Coachella',        totalTax: 8.75  },
          { name: 'Corona',           totalTax: 8.75  },
          { name: 'Desert Hot Springs',totalTax: 8.75 },
          { name: 'Eastvale',         totalTax: 7.75  },
          { name: 'Hemet',            totalTax: 8.75  },
          { name: 'Indian Wells',     totalTax: 7.75  },
          { name: 'Indio',            totalTax: 8.75  },
          { name: 'Jurupa Valley',    totalTax: 7.75  },
          { name: 'La Quinta',        totalTax: 8.75  },
          { name: 'Lake Elsinore',    totalTax: 8.75  },
          { name: 'Menifee',          totalTax: 8.75  },
          { name: 'Moreno Valley',    totalTax: 8.75  },
          { name: 'Murrieta',         totalTax: 8.75  },
          { name: 'Norco',            totalTax: 8.75  },
          { name: 'Palm Desert',      totalTax: 8.75  },
          { name: 'Palm Springs',     totalTax: 9.25  },
          { name: 'Perris',           totalTax: 7.75  },
          { name: 'Rancho Mirage',    totalTax: 7.75  },
          { name: 'Riverside',        totalTax: 8.75,  zipPrefix: ['925'] },
          { name: 'San Jacinto',      totalTax: 8.75  },
          { name: 'Temecula',         totalTax: 8.75  },
          { name: 'Wildomar',         totalTax: 8.75  },
        ],
      },
      {
        ...
        cities: [
          ...
          { name: 'Clayton',        totalTax: 8.75  },
          { name: 'Concord',        totalTax: 9.75  },
          { name: 'Danville',       totalTax: 8.75  },
          { name: 'El Cerrito',     totalTax: 10.25 },
          { name: 'Hercules',       totalTax: 9.25  },
          { name: 'Lafayette',      totalTax: 9.25  },
          { name: 'Martinez',       totalTax: 9.75  },
          { name: 'Moraga',         totalTax: 9.75  },
          { name: 'Oakley',         totalTax: 8.75  },
          { name: 'Orinda',         totalTax: 9.75  },
          { name: 'Pinole',         totalTax: 10.25 },
          { name: 'Pittsburg',      totalTax: 9.25  },
          { name: 'Pleasant Hill',  totalTax: 9.25  },
          { name: 'Richmond',       totalTax: 9.75  },
          { name: 'San Pablo',      totalTax: 9.5   },
          { name: 'San Ramon',      totalTax: 9.75  },
          { name: 'Walnut Creek',   totalTax: 9.25  },
        ],
      },
    ],
    // Flat cities list for backward-compat / GPS partial match
    cities: [
      { name: 'Los Angeles',    zipPrefix: ['900','901','902','903','904'], totalTax: 9.75  },
      ...
      { name: 'Long Beach',     zipPrefix: ['908'],                         totalTax: 10.5  },
      { name: 'Anaheim',        zipPrefix: ['928'],                         totalTax: 7.75  },
      { name: 'Oakland',        zipPrefix: ['946'],                         totalTax: 10.75 },
      ...
      { name: 'Santa Clara',    zipPrefix: ['950'],                         totalTax: 9.125 },
