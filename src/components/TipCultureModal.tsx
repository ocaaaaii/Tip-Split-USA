...
const CONTENT: Record<Scenario, { icon: string } & Record<Lang, LangContent>> = {
  restaurant: {
    ...
    zh: {
      range: '18 – 22%',
      rule: '這是美國文化中最強烈的小費場合。服務生的薪水很低（通常只有 $2–5/hr），小費是主要收入來源。',
      tips: [
        '6人以上請先看帳單底部是否已有 Auto-Gratuity（通常 18%）',
        '稅前計算小費才是正確做法，幫你省錢',
        '服務差也建議至少給 15%，有問題找經理反映更有效',
        '如果覺得服務特別好，可以多給到 25%',
      ],
      skip: '不適合跳過。',
    },
    en: {
      ...
      tips: [
        'For 6+ guests, check if Auto-Gratuity is already on the bill (usually 18%)',
        'Tip on pre-tax subtotal to save money',
        'Even bad service warrants 15% — complain to the manager instead',
        'Great service? 25%+ is always appreciated',
      ],
